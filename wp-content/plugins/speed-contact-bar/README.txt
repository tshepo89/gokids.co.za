...
Tags: address, bottom, cell phone, contact, contacts, e-mail, email, facebook, flickr, g+, google plus, google+, icons, imdb, instagram, link, linkedin, number, phone, pinterest, position, responsive, skype, slideshare, snapchat, social media, soundcloud, telephone, top, transparent, tumblr, twitter, url, vimeo, web, xing, yelp, youtube
...
* **"Easy Peasy Lemon Squeezy!"** in [WordPress.org Reviews](https://wordpress.org/support/topic/easy-peasy-lemon-squeezy-2) by Beefy on February 10, 2015
...
View the video [**Installation & Configuration of Sticky Popup WordPress Plugin** on Youtube](https://www.youtube.com/watch?v=uLRyHyKIh8M) by Wordpress Support on August 19, 2015.
...
3. **Phone number**, automatically **linked** to open an available phone application
4. **Cell phone number**, automatically **linked** to open an available phone application
5. **E-Mail address**, automatically **linked** to open an available mail client, can be displayed with a text of your choice
6. any further content you wish by using the filter hook `speed-contact-bar-data`
...
16. Yelp
17. Youtube
18. any further content you wish by using the filter hook `speed-contact-bar-icons`. See [Other Notes](https://wordpress.org/plugins/speed-contact-bar/other_notes/)
...
= 4.5.3 =
* Successfully tested width WP 4.7
...
* Successfully tested width WP 4.6.1
...
= 4.5.1 =
Removed conversion of '+' to '00' in phone numbers, tested width WP 4.6.1
