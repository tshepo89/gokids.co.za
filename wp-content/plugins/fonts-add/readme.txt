=== Google Font  ===
Contributors: smuzthemes,Zia Imtiaz
Tags: Google-fonts, Google, fonts, theme-fonts, font-changer, web-fonts, web-safe-fonts, theme-font-changer, font,typeface, text, font family, custom fonts, paragraph, heading
...
1. Search for plugin "Fonts Add".
1. Click "Install".
1. After Installation click activate to start using the Google Font plugin.
...
1. Download the Google font plugin.
1. Unarchive Google font plugin.
1. Copy folder with fonts-add.zip
1. Open the ftp \wp-content\plugins\
1. Paste the fonts-add folder in the plugins folder.
1. Go to admin panel => open item "Plugins" => activate Google font.
